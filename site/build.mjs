...
const renderImplementationLevels = (ctx) => `
  <section class="implementation-section" aria-labelledby="levels-heading">
    <div class="section-heading"><p class="eyebrow">FOUR PROPORTIONATE CHOICES</p><h2 id="levels-heading">Choose the smallest route that fits the decision.</h2><p>No provider, model, database, graph, or custom service is required. Ordinary is valid only for an already-permitted, reversible supplied-material transformation that requires no material claim judgment, comparison, selection or withholding, permission resolution, memory reuse, acquisition, human action gate, or consequential external influence.</p></div>
...
const renderRouteStudio = (ctx) => `
  <section class="route-studio-section" id="route-studio" aria-labelledby="route-studio-heading">
    ...
    <div class="section-heading"><p class="eyebrow">LOCAL ROUTE STUDIO / NO PROVIDER</p><h2 id="route-studio-heading">Build a recommendation, not a fictional receipt.</h2><p>Supplied material does not automatically make a task ordinary. Use Stage 0 only for an already-permitted, reversible transformation with no material claim judgment, comparison, selection or withholding, permission resolution, memory reuse, acquisition, human action gate, or consequential external influence. Otherwise choose the smallest layered conditions. The browser can recommend a level, next action, required gate, ${renderTerm("planned-stop-condition", "apply-stop", ctx)}, and learning option. It does not grant permission, execute work, observe an outcome, or decide for anyone. ${renderTerm("human-authority", "apply-authority", ctx)} remains separate.</p></div>
