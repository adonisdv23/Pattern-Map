...
const familyPublicCopy = {
  ...
  F2: {
    purpose: "What can this source actually tell us about this claim, and what can it not tell us?",
    boundary: "Recurrence, authority, support, relevance, origin, and permission stay distinct.",
