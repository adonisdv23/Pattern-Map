...
| Owner visual/export closeout | `qa/site/OWNER_VISUAL_EXPORT_CLOSEOUT_2026-08-23.md` | Separates the alternate jsPDF failure from current source, records the flow-native recurrence repair, term-helper containment, and print-width safeguards |
