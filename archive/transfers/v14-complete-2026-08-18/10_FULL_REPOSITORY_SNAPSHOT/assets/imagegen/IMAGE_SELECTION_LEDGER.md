# V14 image selection ledger

**Decision date:** 2026-08-18  
**Status:** local editorial-asset decision; no publication authorized  
**Rubric:** 0–4 on conceptual fidelity (CF), non-misleading structure (NM), complementarity (CO), editorial fit (EF), crop resilience (CR), accessibility support (AS), and craft/distinctiveness (CD). A production candidate must score at least 20/28, receive no zero in CF/NM/CR, and exist as a clean local asset without interface chrome.
...
| Candidate | Route | CF | NM | CO | EF | CR | AS | CD | Total | Disposition |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| S1 — Nine observations, one shared origin | OpenAI image-generation tool | 4 | 4 | 4 | 4 | 4 | 4 | 4 | **28** | **Selected.** It uses a nine-to-one paper-fragment motif plus two visibly separate comparison roots, with accurate title text and no workflow arrows, status badges, truth semantics, or model branding. |

### Selected social-card asset
...
- Scope: share-preview art only. It does not define the framework topology or provide evidence.
...
The final local site uses one generated worked-example image, one generated social-share card, and the unchanged historical v13 anchor. The risky hero experiment is archived but omitted from the rendered deliverables. The six-family map, component count, two-loop relationship, route states, evidence labels, and citations remain deterministic HTML and live text. No generated raster defines a component, sequence, truth state, or empirical result.
