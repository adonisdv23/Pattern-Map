...
- “before generation” means one chronological preprocessing phase before the
  first model call, or that selection and correction stop once generation has
  begun;
- a Pattern Map receipt, ledger, trace graph, or claim/evidence view is a new
  technical mechanism merely because the project combines fields differently;
  or
