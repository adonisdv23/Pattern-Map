...
| `PUB-07` bitmap/social card | **Rejected** | none | `assets/generated-candidates/**`, image ledger | No written bitmap need or authorized destination; no candidate was created. A future exact channel decision may revisit the question. |
