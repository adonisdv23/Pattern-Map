...
| A02 — human problem first | **PASS** | Frozen headline/standfirst, route source, `site/check.mjs`, and live default/390-pixel browser inspection show the human problem and early concrete example before the three visually distinct principal doors, protocol, research status, or Echo. | This is composition/semantic evidence, not persuasion evidence. |
